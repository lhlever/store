...
<html>
  <head>
    ...
    <title>My JSP 'cancelCheck.jsp' starting page</title>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-7" data-genuitec-path="/week7/WebRoot/cancelCheck.jsp">
    ...
    String sql="delete from login where username='"+user.getUsername()+"'and pwd='"+user.getPwd()+"'";
    int result=stmt.executeUpdate(sql);
    if(result!=0){
    	response.sendRedirect("login.jsp");
    }else{
    	request.setAttribute("news","用户名或密码错误或用户名错误");
