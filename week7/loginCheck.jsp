...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-2" data-genuitec-path="/week7/WebRoot/loginCheck.jsp">
    ...
    String sql="select * from login where username='"+user.getUsername()+"'and pwd='"+user.getPwd()+"'";
    ResultSet rs=stmt.executeQuery(sql);
    if(rs.next()&&rs.getString(4).equals("1")){
